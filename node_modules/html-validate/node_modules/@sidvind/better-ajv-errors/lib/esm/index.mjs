...
var BaseValidationError = class {
  constructor(options = { isIdentifierLocation: false }, { data, schema, jsonAst, jsonRaw, colors }) {
...
`];
    return output.concat(
      this.getCodeFrame(
        bestMatch !== null ? `Did you mean ${property(bestMatch)} here?` : `Unexpected value, should be equal to one of the allowed values`
      )
    );
  }
  getError() {
